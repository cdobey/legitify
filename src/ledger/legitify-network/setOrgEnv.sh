...
function setGlobals() {
  ...
  if [ $USING_ORG = orguniversity ]; then
    ...
    export CORE_PEER_ADDRESS=3.249.159.32:7051
    ...
    export CORE_PEER_ADDRESS=3.249.159.32:8051
    export FABRIC_CFG_PATH=${PWD}/configtx
    ...
    export CORE_PEER_ADDRESS=3.249.159.32:9051
    export FABRIC_CFG_PATH=${PWD}/configtx
  else
...
function setOrdererGlobals() {
  ...
  export CORE_PEER_ADDRESS=3.249.159.32:7050
  export FABRIC_CFG_PATH=${PWD}/configtx
}
