...
SUPABASE_URL="https://japzugjgdlvqkmytralh.supabase.co"
ANON_KEY="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImphcHp1Z2pnZGx2cWtteXRyYWxoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDA1MTM1MTYsImV4cCI6MjA1NjA4OTUxNn0.HOoTMhK5e_CAI4ppYyX3pGpGB763Su4HPT9o1AUU5Ps"

echo -e "${BLUE}Starting Supabase test flow...${NC}"
...
-H "apikey: $ANON_KEY" || echo '{"error":"Connection failed"}')
